...
export default function ManageGroceryListsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold mb-2">Manage Grocery Lists</h1>
          <p className="text-gray-600">Review, edit, or open an existing list</p>
        </div>
